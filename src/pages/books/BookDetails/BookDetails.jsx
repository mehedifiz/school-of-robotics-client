            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="md:w-3/4 lg:w-4/5 mt-6 md:mt-32">
                ...
                <div className="flex flex-wrap gap-3 mt-6">
                  <button onClick={handleStartReading} className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors">
                    Start Reading
                  </button>
                  ...
                  book.chapters.map((chapter, index) => (
                    <div key={chapter} className="py-4">
                      <button className="flex w-full justify-between items-center focus:outline-none" onClick={() => toggleChapter(index)}>
                        <div className="flex items-center">
                          <div className="bg-blue-50 text-blue-800 w-8 h-8 rounded-full flex items-center justify-center mr-3 font-semibold">{index + 1}</div>
                      ...
                      {activeChapter === index && (
                        <div className="mt-3 pl-11">
                          ...
                          {userCanAccess() ? (
                            <Link to={`/book-reading/${book._id}/chapter/${chapter}`} className="inline-flex items-center text-blue-600 hover:text-blue-800">
