      ...
      <div className="mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button
            ...
            className={`px-3 py-1 text-xs rounded-full ${selectedPlan === "premium" ? "bg-primary text-white" : "bg-gray-100 text-gray-700 hover:bg-gray-200"}`}
          >
            Premium
          </button>
        </div>
              ...
              <div className="flex items-center">
                ...
                <div className="overflow-hidden">
                  ...
                  <div className="flex items-center mt-1">
                    <span className={`text-xs capitalize px-2 py-0.5 rounded-full ${getPlanBadgeStyle(book.plan)}`}>{book.plan}</span>
