            ...
            <div className="w-full md:w-96">
              <div className="relative">
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 rounded-lg border-0 focus:ring-2 text-white focus:ring-primary"
                />
                  ...
                  <div className="flex justify-between items-start mb-4">
                    ...
                    >
                      {({ loading }) => (
                        <button
                          disabled={loading}
                          className="flex items-center space-x-2 px-3 py-1.5 bg-blue-50 text-primary rounded-lg hover:bg-blue-100 transition-colors duration-200"
                        >
                          <Download size={16} />
