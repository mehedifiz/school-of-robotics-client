...
import StuBooksCard from "./StuBooksCard";
    ...
    return (
      ...
      <div className="grid grid-cols-1 mt-8 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {filteredBooks.map((book) => (
          <StuBooksCard key={book._id} book={book}></StuBooksCard>
        ))}
      </div>
    </div>
    );
