            ...
            <div className=" mx-auto flex justify-between items-center">
               ...
               <div className="flex items-center space-x-5">
                  <form className="border flex items-center border-gray-300  rounded-sm pl-2 ">
                     <CiSearch />
                     <input type="search" name="" className="p-1.5 outline-0 border-none placeholder:text-sm" placeholder="Search Course"/>
                  </form>

                  <Link to='/register' className="bg-primary px-4 py-2 rounded-full text-white inline-block text-sm font-semibold">
